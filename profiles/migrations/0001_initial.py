...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.City'], null=True, blank=True)),
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.City']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
